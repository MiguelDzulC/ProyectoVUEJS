    ...
    <svg width="20%" height="50%" viewBox="0 0 500 150" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="
            ...
            <g>
              <g>
                <g>
                  <g id="Capa2">
                    <path d="M82.775,89.986l-9.562,-15.753l-18.702,-0.24c0,0 9.563,15.754 9.563,15.754l18.701,0.239Z" style="fill: none; stroke: #ffffff; stroke-width: 3px"></path>
                    <path d="M45.378,89.504l9.133,-15.511c0,0 9.563,15.755 9.563,15.754c0,0.001 -9.135,15.509 -9.135,15.509l-9.561,-15.752Z" style="fill: none; stroke: #ffffff; stroke-width: 3px"></path>
                    <path d="M64.074,89.747l-9.135,15.509l18.697,0.245l9.139,-15.515l-18.701,-0.239Z" style="fill: none; stroke: #ffffff; stroke-width: 3px"></path>
                  </g>
                ...
                <path d="M69.034,61.836l19.288,-32.745l-8.61,-4.872" style="fill: none; stroke: #ffffff; stroke-width: 8px"></path>
                <path d="M86.255,71.582l19.289,-32.745l8.61,4.872" style="fill: none; stroke: #ffffff; stroke-width: 9px"></path>
              </g>
              <path d="M132.38,113.192l-0,-49.971l7.193,-0l-0,49.971l-7.193,0Zm6.953,-49.731l-6.713,-0l-0,49.491l6.713,0l0,-49.491Zm-6.953,-0.24l-0,49.971l7.193,0l-0,-49.971l-7.193,-0Z" style="fill: #ffffff; fill-rule: nonzero"></path>
              ...
              <path d="M295.381,105.999l-0,-43.063l-7.193,-0l-0,50.256l38.805,0l0,-7.193l-31.612,0Z" style="fill: #ffffff; fill-rule: nonzero"></path>
              <path d="M342.272,113.192l9.502,0l15.817,-28.582l-4.726,-8.622l-20.593,37.204Zm32.452,-41.464l-4.752,-8.584l-0.003,0.005l-4.747,8.579l22.948,41.464l9.504,0l-22.95,-41.464Z" style="fill: #ffffff; fill-rule: nonzero"></path>
    ...
    <div class="max-w-screen-xl px-4 py-3 mx-auto md:px-6">
        <div class="flex items-center">
            <ul class="flex flex-row mt-0 mr-6 space-x-8 text-sm font-medium ">
                <li class="hover:-translate-y-1 hover:scale-110 duration-100 hover:text-blue-400">
